            ...
            (0, r.jsxs)("div", {
              ...
              children: [
                (0, r.jsx)(i.P.div, {
                  ...
                  style: {
                    "--game-color":
                      (null == F ? void 0 : F.primaryColor) || "#3b82f6",
                  },
                  ...
                  children: z.map((e, t) => {
                    ...
                    return (0, r.jsx)(
                      i.P.div,
                      {
                        ...
                        style: {
                          "--game-color": null == F ? void 0 : F.primaryColor,
                        },
                        className:
                ...
                q.length > _ &&
                  (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)("button", {
                      ...
                      className:
                        "flex items-center gap-2 px-8 py-3 rounded-xl bg-[var(--game-color)]/10 border border-[var(--game-color)]/30 text-[var(--game-color)] font-bold hover:bg-[var(--game-color)]/20 transition-all duration-300 orbitron-font",
                      children:
                                    ...
                                    children: [
                                      ...
                                      (0, r.jsxs)(
                                        "button",
                                        {
                                          onClick: () => p(e.id),
                                          className:
                                            "p-5 rounded-xl border transition-all duration-300 flex flex-col items-center gap-2 ".concat(
                                              x === e.id
                                        ...
                                        children: [
                                          (0, r.jsx)("button", {
                                            onClick: () =>
                                              v(Math.max(0, y - 1)),
                                            className:
                                              "w-10 h-full hover:bg-black/5 dark:hover:bg-white/5 rounded-lg text-lg text-gray-400",
                                            children: "-",
                                          }),
                                          (0, r.jsx)("div", {
                                            className:
                                  ...
                                  (0, r.jsxs)("div", {
                                    ...
                                    children: [
                                      ...
                                      (0, r.jsxs)("div", {
                                        onClick: () => j(!w),
                                        className:
                                          "flex items-center justify-between border px-4 h-12 rounded-xl transition-all duration-500 ".concat(
                                            w
                                              ? "bg-white/[0.03] border-secondary cursor-pointer"
                          ...
                          (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsxs)("div", {
                              ...
                              children: [
                                (0, r.jsx)("div", {
                                  className:
                                    "h-1.5 w-full bg-gradient-to-r from-[#2563EB] to-[#06B6D4]",
                                }),
                                (0, r.jsxs)("div", {
                                  className:
                                    ...
                                    (0, r.jsxs)("div", {
                                      ...
                                      children: [
                                        ...
                                        (0, r.jsxs)("a", {
                                          ...
                                          target: "_blank",
                                          className:
                                            "group w-full py-4 bg-gradient-to-r from-[#2563EB] to-[#06B6D4] hover:opacity-90 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95 uppercase tracking-widest text-[11px] orbitron-font",
                                          children: [
                                            "Deploy Now",
                                            (0, r.jsx)(n.A, {
                                              className:
